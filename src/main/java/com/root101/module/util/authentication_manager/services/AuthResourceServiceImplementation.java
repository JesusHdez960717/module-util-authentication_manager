 ...
 */
public class AuthResourceServiceImplementation implements ResourceService {

    public static final String RESOURCE_URL = "module_auth_manager";

    private final DefaultResourceBundleService resourceService;

    public static AuthResourceServiceImplementation init() throws MalformedURLException {
        AuthResourceServiceImplementation res = new AuthResourceServiceImplementation();
        ResourceHandler.registerResourceService(res);
        return res;
    }

    private AuthResourceServiceImplementation() throws MalformedURLException {
